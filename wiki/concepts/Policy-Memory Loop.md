...
2. **PR substrate.** The pull request is the durable record, not a committed sidecar. CI posts a machine-readable finding block in its PR comment. The cross-machine signal lives on GitHub, read back via `gh`.
