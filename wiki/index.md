...
- [[Claude Integration Fitness]] — shared check taxonomy + F-to-A+ grading + triage/heal protocol consumed by /gaia fitness and /health-audit's shared-fitness bucket.
<!-- gaia:maintainer-only:start -->
