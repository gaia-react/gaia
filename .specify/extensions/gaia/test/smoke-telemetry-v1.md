...
- **UAT-022.** A `time_to_resolved_spec` event with `question_count: 8`, `question_ceiling: 10`, `duration_seconds: 1850`, `abandoned: false`, `area_tags`. `.gaia/cli/gaia telemetry emit time_to_resolved_spec --spec-id SPEC-300 --area-tags visual --question-count 8 --duration-seconds 1850 --question-ceiling 10`.
