 ...
 * written by `gaia telemetry compute-profile` (Phase 5 sibling task) is:
 *
 *     ## Active adaptations
 *
 ...
 *
 * Per the task brief, the read path is lock-free: UAT-035 atomic write
 * via write-temp-and-rename guarantees we either see the prior version
 * in full or the new version in full — never half-state.
 */
