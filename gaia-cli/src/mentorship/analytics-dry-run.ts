...
/**
 * `gaia mentorship analytics dry-run` (UAT-043).
 *
 ...
 *    (Phase 5's `task-analytics-report` writes those files; until Phase 5 ships,
 *    `dry-run` always returns `no_analytics_report` per the brief's note.)
