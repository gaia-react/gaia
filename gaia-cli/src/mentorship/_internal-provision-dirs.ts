/* eslint-disable unicorn/prevent-abbreviations -- the filename is a frozen
   ...
   wired into gaia-init's slash-command flow per the SPEC-001 plan README's
   Phase 3 coordination notes. Renaming would break the dispatcher. */
/**
 * Internal subcommand consumed by gaia-init's slash-command flow.
 *
 * Locked subcommand name (per Phase 3 coordination notes):
 *
