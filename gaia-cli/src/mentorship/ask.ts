 ...
 *
 * The `--yes` flag (UAT-045) is the documented non-interactive bypass for
 * scripted / CI use. When `yesFlag === true`, this returns `true` immediately
 * without touching stdin or invoking any prompt — UAT-045 mandates that
 * structured stdout/stderr stays parseable in scripted contexts.
 *
