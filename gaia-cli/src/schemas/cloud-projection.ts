...
//
// UAT-013: forbidden fields (developer_id, email, username, GitHub username,
// machine ID, hostname, IP) never appear.
//
// UAT-014: drift fails loud — every schema is `.strict()`. An unexpected
// field on a cloud event triggers a non-zero exit at projection time.
//
...
// projection fails loud (UAT-013 belt-and-suspenders).
