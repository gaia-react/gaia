 ...
 * - Atomic write contract (UAT-035): write-temp-and-rename, mode 0o600.
 * - DO-NOT-EDIT header (UAT-036) is the first line, exact wording.
 */
 ...
 * (UAT-035). Mode 0o600 because profile.md lives under the off-project
