 ...
 *
 * Example: an articulation-gap adaptation active for 3 weeks where the user's
...
/**
 * flake_suspected uat_fail events are downweighted by 0.25. Used by future
 * patterns that aggregate uat_fail rates; not exercised directly by the v1
 * articulation/knowledge/intent-clarity detectors. Lands here as a shared
 * utility for downstream features.
 */
