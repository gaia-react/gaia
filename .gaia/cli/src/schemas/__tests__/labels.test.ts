...
describe('schemas/labels', () => {
  ...
  test('the committed registry has exactly 33 entries, split by role and by audience field', () => {
    ...
    expect(adopterRole).toHaveLength(23);
    ...
    expect(adopterField).toHaveLength(27);
