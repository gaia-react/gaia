...
describe('schemas/labels', () => {
  ...
  test('the committed registry has exactly 32 entries, split by role and by audience field', () => {
    ...
    expect(adopterRole).toHaveLength(22);
    ...
    expect(adopterField).toHaveLength(26);
