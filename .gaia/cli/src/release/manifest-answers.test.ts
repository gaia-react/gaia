...
describe('validateAnswers', () => {
  ...
  test.each([
    ...
    // Every wiki/ title carries spaces, and .gaia/release-exclude already
    // holds such lines. An exclude line is a literal path to every consumer,
