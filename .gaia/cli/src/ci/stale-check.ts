 ...
 * (Phase 2 composite action). Both `--label` AND `--author` predicates
 * are required to fire a skip; a label-only or author-only match must
 * NOT skip. We delegate predicate evaluation to `gh pr list`
