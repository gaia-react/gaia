...
# test plus its runtime deps (plan-ledger-update.sh, with-ledger-lock.sh) into
# a sibling lib dir so the ${BASH_SOURCE[0]}-relative source resolves, and
# seed the plans ledger explicitly.
