...
What catches it here is that check's own bats suite, `.gaia/scripts/tests/check-debt-issue-metadata.bats`, which pins the `'difficulty:'` spelling: a forgotten prefix reds there instead of passing silently.
<!-- gaia:maintainer-only:end -->
